...
export AWS_ACCOUNT_ID="337909737340"             # Your AWS account ID
...
echo "Check status in AWS Console: App Runner → Services → $ECR_REPO_NAME"
echo ""

# Optional: Get recent logs
echo "Fetching recent CloudWatch logs..."
LOG_GROUP="/aws/apprunner/$ECR_REPO_NAME"
